  ...
  return (
    <section id="apps-web" className="py-24 relative overflow-hidden bg-slate-950">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-amber-500/20 border border-blue-500/30 mb-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-16">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group glass-effect rounded-2xl p-6 border border-white/10 hover:border-orange-500/40 transition-all duration-300 hover:-translate-y-1"
            >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {techStack.map((tech, index) => (
              <motion.div
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 hover:border-orange-500/50 transition-all cursor-default"
              >
        ...
        >
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-blue-500/10">
            ...
            <div className="bg-slate-900/80 p-6 font-mono text-sm leading-relaxed">
              <p><span className="text-blue-400">const</span> <span className="text-orange-300">tuApp</span> <span className="text-white">=</span> <span className="text-yellow-300">{'{'}</span></p>
        ...
        >
          <Button
            ...
            size="lg"
            className="bg-gradient-to-r from-blue-600 to-amber-500 hover:from-blue-700 hover:to-amber-600 hover:shadow-lg hover:shadow-blue-500/25 text-lg px-10 py-6 rounded-full"
          >
